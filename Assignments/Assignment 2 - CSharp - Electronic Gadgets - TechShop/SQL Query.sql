...
CREATE TABLE Customers (CustomerID INT PRIMARY KEY, FirstName VARCHAR(20) NOT NULL, LastName VARCHAR(20), Email VARCHAR(50), Phone DECIMAL NOT NULL, Address VARCHAR(60));
...
CREATE TABLE Products (ProductID INT PRIMARY KEY, ProductName VARCHAR(30) NOT NULL, Description VARCHAR(60), Price INT NOT NULL);
...
CREATE TABLE Orders (OrderID INT PRIMARY KEY, CustomerID INT FOREIGN KEY REFERENCES Customers(CustomerID), OrderDate DATETIME, TotalAmount INT, OrderStatus VARCHAR(20));
INSERT INTO Orders VALUES (1,  5,  '2024-09-01', 1000,  'Pending');
INSERT INTO Orders VALUES (2,  7,  '2024-09-02', 3000,  'Pending');
INSERT INTO Orders VALUES (3,  6,  '2024-09-02', 10000, 'Pending');
INSERT INTO Orders VALUES (4,  4,  '2024-09-03', 4000,  'Pending');
INSERT INTO Orders VALUES (5,  9,  '2024-09-04', 2000,  'Pending');
INSERT INTO Orders VALUES (6,  2,  '2024-09-06', 500,   'Pending');
INSERT INTO Orders VALUES (7,  1,  '2024-09-15', 200,   'Pending');
INSERT INTO Orders VALUES (8,  3,  '2024-09-16', 10000, 'Pending');
INSERT INTO Orders VALUES (9,  8,  '2024-09-17', 6000,  'Pending');
INSERT INTO Orders VALUES (10, 10, '2024-09-18', 7000,  'Pending');
SELECT * FROM Orders;
